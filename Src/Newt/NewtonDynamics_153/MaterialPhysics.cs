...
namespace Game.Newt.NewtonDynamics_153
{
    public class MaterialPhysics
    {
        ...
        private void ContactBegin(object sender, Game.Newt.NewtonDynamics_153.Api.CContactBeginEventArgs e)
        {
            #region Get Keys
        ...
        private void ContactProcess(object sender, Game.Newt.NewtonDynamics_153.Api.CContactProcessEventArgs e)
        {
            #region Get Keys
        ...
        private void ContactEnd(object sender, Game.Newt.NewtonDynamics_153.Api.CContactEndEventArgs e)
        {
