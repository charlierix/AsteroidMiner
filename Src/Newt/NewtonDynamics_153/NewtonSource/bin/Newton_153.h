...
extern "C" {
	...
	NEWTON_API void NewtonConvexHullModifierGetMatrix3D (const NewtonCollision* convexHullCollision, dFloat* matrix);
	NEWTON_API void NewtonConvexHullModifierSetMatrix3D (const NewtonCollision* convexHullCollision, const dFloat* matrix);
	...
	NEWTON_API void  NewtonBodySetMatrix3D (const NewtonBody* body, const dFloat* matrix);
...
// NEWTON_API void NewtonRagDollBoneSetGlobalMatrix3D (const NewtonRagDollBone* bone, dFloat* matrix);
	...
	NEWTON_API void NewtonVehicleGetTireMatrix3D (const NewtonJoint* vehicle, void* tireId, dFloat* matrix);
