...
namespace Game.Newt.AsteroidMiner2.ShipParts
{
    ...
    public class SensorSpinToolItem : PartToolItemBase
    {
        ...
        {
            return new SensorSpinDesign(this.Options);
        }
    ...
    public class SensorSpinDesign : PartDesignBase
    {
        ...
        public SensorSpinDesign(EditorOptions options)
            : base(options) { }
        ...
        private Model3DGroup CreateGeometry(bool isFinal)
        {
            return SensorGravityDesign.CreateGeometry(this.MaterialBrushes, base.SelectionEmissives,
                ...
                WorldColors.SensorBase, WorldColors.SensorBaseSpecular, WorldColors.SensorSpin, WorldColors.SensorSpinSpecular,
                isFinal);
        }
    ...
    public class SensorSpin : PartBase, INeuronContainer, IPartUpdatable
    {
        ...
        public SensorSpin(EditorOptions options, ItemOptions itemOptions, PartNeuralDNA dna, IContainer energyTanks)
            : base(options, dna)
        {
            _itemOptions = itemOptions;
            _energyTanks = energyTanks;

            this.Design = new SensorSpinDesign(options);
        ...
        {
            if (_energyTanks.RemoveQuantity(elapsedTime * _volume * _itemOptions.SpinSensorAmountToDraw * ItemOptions.ENERGYDRAWMULT, true) > 0d)
            {
