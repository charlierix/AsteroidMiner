...
namespace Game.Newt.AsteroidMiner2
{
	...
	public class GravityField
	{
		...
		//private volatile bool _hasBoundryField = false;
		///// <summary>
		///// This will be an inward pointing force near the boundry of the map.  It is a way to slow things down before
		///// hitting the edge of the map, and can be thought of as an elliptical shell
		///// </summary>
		//public bool HasBoundryField
		//{
		//    get
		//    {
		//        return _hasBoundryField;
		//    }
		//    set
		//    {
		//        _hasBoundryField = value;
		//    }
		//}

		//private volatile double _boundryFieldStartPercent = .85d;
		///// <summary>
		///// This is the percent of the map's size where the boundry force starts to be felt
		///// </summary>
		//public double BoundryFieldStartPercent
		//{
		//    get
		//    {
		//        return (double)_boundryFieldStartPercent;
		//    }
		//    set
		//    {
		//        _boundryFieldStartPercent = value;
		//    }
		//}

		//private volatile object _boundryFieldStrengthHalf = 1000d;
		///// <summary>
		///// This is the strength of the force halfway between the start of the boundry and the map's edge (the strength doesn't climb linearly, it's quadratic)
		///// </summary>
		//public double BoundryFieldStrengthHalf
		//{
		//    get
		//    {
		//        return (double)_boundryFieldStrengthHalf;
		//    }
		//    set
		//    {
		//        _boundryFieldStrengthHalf = value;
		//    }
		//}

		////	The edges of the map
		//private volatile object _boundryFieldMapMin = null;
		//public Point3D BoundryFieldMapMin
		//{
		//    get
		//    {
		//        object retVal = _boundryFieldMapMin;
		//        if (retVal == null)
		//        {
		...
		//        else
		//        {
		//            return (Point3D)_boundryFieldMapMin;
		//        }
		//    }
		//    set
		//    {
		//        _boundryFieldMapMin = value;
		//    }
		//}
		//private volatile object _boundryFieldMapMax = null;
		//public Point3D BoundryFieldMapMax
		//{
		//    get
		//    {
		//        object retVal = _boundryFieldMapMax;
		//        if (retVal == null)
		//        {
		//            return new Point3D(0, 0, 0);
		//        }
		//        else
		//        {
		//            return (Point3D)_boundryFieldMapMax;
		//        }
		//    }
		//    set
		//    {
		//        _boundryFieldMapMax = value;
		//    }
		//}
		...
		public Vector3D GetForce(Point3D point)
		{
			...
			if (!Math3D.IsInside(root.MinRange, root.MaxRange, point))
			{
		...
		private static double BuildFieldSprtNodeSprtAncestorMass(MapOctree[] ancestors, Point3D minRange, Point3D maxRange)
		{
			...
			for (int ancestorCntr = 0; ancestorCntr < ancestors.Length; ancestorCntr++)
			{
				...
				for (int itemCntr = 0; itemCntr < ancestors[ancestorCntr].Items.Length; itemCntr++)
				{
					...
					if (!Math3D.Intersects(item.AABBMin, item.AABBMax, minRange, maxRange))
					{
						continue;
					}
	...
	{
		/// <summary>
		/// This method returns the fluid flow at the location requested
		/// </summary>
		/// <remarks>
		/// The radiation class takes in a normal, and does more calculations there.  But I already make a FluidHull class that does a lot of
		/// those types of calculations
		/// </remarks>
		public void GetForce(out double viscosity, out Vector3D flow, Point3D point)
		{
			viscosity = 0d;
			flow = new Vector3D(0, 0, 0);
		}
	}
	...
	public class FieldOctree<T> where T : class  // the where is needed so that leaf can be marked volatile
	{
		...
		{
			if (!Math3D.IsInside(_minRange, _maxRange, position))
			{
