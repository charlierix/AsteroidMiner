...
namespace Game.Newt.AsteroidMiner2.ShipEditor
{
    ...
    public class DraggableModifierRing : DraggableModifierBase
    {
        ...
        public override void StartDrag(RayHitTestParameters ray)
        {
            ...
            if (Math3D.GetClosestPoints_Line_Circle(out nearestCirclePoints, out nearestLinePoints, _circlePlane, _circleCenter.Value, _radius, ray.Origin, ray.Direction, Math3D.RayCastReturn.ClosestToRay))
            {
