...
namespace Game.Newt.v2.AsteroidMiner.AstMin2D
{
    public class ShipPlayerORIG : Bot
    {
        ...
        public static ShipPlayerORIG GetNewShip(ShipDNA dna, World world, int material_Ship, Map map, ShipExtraArgs extra)
        {
            ...
            return new ShipPlayerORIG(construction);
        }

        protected ShipPlayerORIG(BotConstruction_Result construction)
            : base(construction)
        {
