...
namespace Game.Newt.v2.NewtonDynamics
{
    ...
    public class MaterialCollision
    {
        ...
        /// <summary>
        /// This is useful when there is a collision with a compound collision hull.  This returns the sub hull (look at hull.UserID to get the custom
        /// shapeID that was passed into the create method)
        /// </summary>
        public CollisionHull GetCollisionHull(Body body)
        {
            // This method was commented out
            //return Newton.NewtonMaterialGetBodyCollisionID(_handle, body.Handle);

            // This method was added in 2.36
            IntPtr collisionHandle = Newton.NewtonMaterialGetBodyCollidingShape(_handle, body.Handle);

            return ObjectStorage.Instance.GetCollisionHull(collisionHandle);
        }
    ...
    public class MaterialCollisionArgs : EventArgs
    {
        ...
        private readonly IntPtr _contactHandle;
        ...
        private bool _pulledBody0 = false;
        private Body _body0 = null;
        /// <summary>
        /// WARNING: This can come back null if the body was disposed by the time this event fires
        /// </summary>
        public Body Body0
        {
            get
        ...
        private bool _pulledBody1 = false;
        ...
        {
            Body body0 = this.Body0;
            if (body0 != null && body0.MaterialGroupID == materialID)
            {
                return body0;
            }

            Body body1 = this.Body1;
            if (body1 != null && body1.MaterialGroupID == materialID)
            {
                return body1;
            }
            ...
            {
                throw new ArgumentException(string.Format("Neither body is the requested material: requested={0}, body0={1}, body1={2}", materialID.ToString(), body0.MaterialGroupID.ToString(), body1.MaterialGroupID.ToString()));
            }

            // MaterialID wasn't found, and at least one of the bodies are null
            return null;
        }
