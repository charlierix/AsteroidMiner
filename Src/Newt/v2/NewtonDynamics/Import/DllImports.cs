...
namespace Game.Newt.v2.NewtonDynamics.Import
{
    ...
    internal static class Newton
    {
        ...
        // This one was commented out in the .h and .cpp files
        //[DllImport("newton.dll", CallingConvention = CallingConvention.Cdecl)]
        //internal static extern uint NewtonMaterialGetBodyCollisionID(IntPtr material, IntPtr body);

        // This seems to be a replacement for NewtonMaterialGetBodyCollisionID (returns the entire hull instead of just shapeID)
        [DllImport("newton.dll", CallingConvention = CallingConvention.Cdecl)]
        internal static extern IntPtr NewtonMaterialGetBodyCollidingShape(IntPtr material, IntPtr body);
        ...
        //TODO: This is uncommented in 2.36
        //internal static extern IntPtr NewtonCreateCompoundCollisionFromMesh (IntPtr newtonWorld, IntPtr mesh, dFloat hullTolerance, int shapeID, int subShapeID);
        ...
        [DllImport("newton.dll", CallingConvention = CallingConvention.Cdecl)]
        internal static extern IntPtr NewtonMeshApproximateConvexDecomposition(IntPtr mesh, float maxConcavity, int maxCount);
