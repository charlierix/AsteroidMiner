...
namespace Game.Newt.v2.GameItems.ShipParts
{
    ...
    public class SensorTractorToolItem : PartToolItemBase
    {
        ...
        {
            return new SensorTractorDesign(this.Options);
        }
    ...
    public class SensorTractorDesign : PartDesignBase
    {
        ...
        public SensorTractorDesign(EditorOptions options)
            : base(options) { }
        ...
        private Model3DGroup CreateGeometry(bool isFinal)
        {
            return SensorGravityDesign.CreateGeometry(this.MaterialBrushes, base.SelectionEmissives,
                ...
                WorldColors.SensorBase, WorldColors.SensorBaseSpecular, WorldColors.SensorTractor, WorldColors.SensorTractorSpecular,
                isFinal);
        }
