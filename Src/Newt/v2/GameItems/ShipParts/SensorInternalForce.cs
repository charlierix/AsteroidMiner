...
namespace Game.Newt.v2.GameItems.ShipParts
{
    ...
    public class SensorInternalForceToolItem : PartToolItemBase
    {
        ...
        public override string Description
        {
            get
            {
                return "Reports the total force exerted by internal components (thrusters, tractor beams, recoil, etc)";
            }
        }
        ...
        {
            return new SensorInternalForceDesign(this.Options);
        }
    ...
    public class SensorInternalForceDesign : PartDesignBase
    {
        ...
        public SensorInternalForceDesign(EditorOptions options)
            : base(options) { }
        ...
        {
            return new SensorInternalForceToolItem(this.Options);
        }
        ...
        private Model3DGroup CreateGeometry(bool isFinal)
        {
            return SensorGravityDesign.CreateGeometry(this.MaterialBrushes, base.SelectionEmissives,
                ...
                WorldColors.SensorBase, WorldColors.SensorBaseSpecular, WorldColors.SensorInternalForce, WorldColors.SensorInternalForceSpecular,
                isFinal);
        }
