...
namespace Game.Newt.v2.GameItems.ShipParts
{
    ...
    public class SensorVelocityToolItem : PartToolItemBase
    {
        ...
        {
            return new SensorVelocityDesign(this.Options, false);
        }
    ...
    public class SensorVelocityDesign : PartDesignBase
    {
        ...
        public SensorVelocityDesign(EditorOptions options, bool isFinalModel)
        ...
        {
            return new SensorVelocityToolItem(this.Options);
        }
        ...
        private Model3DGroup CreateGeometry(bool isFinal)
        {
            return SensorGravityDesign.CreateGeometry(this.MaterialBrushes, base.SelectionEmissives,
                ...
                WorldColors.SensorBase_Color, WorldColors.SensorBase_Specular, WorldColors.SensorVelocity_Color, WorldColors.SensorVelocity_Specular,
                isFinal);
        }
