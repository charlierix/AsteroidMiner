...
namespace SharpNeat.Decoders.HyperNeat
{
    ...
    public class Substrate
    {
        ...
        /// </summary>
        public readonly IActivationFunctionLibrary _activationFnLibrary;
        /// <summary>
        ...
        public INetworkDefinition CreateNetworkDefinition(IBlackBox blackbox, bool lengthCppnInput)
        {
            ...
            foreach (SubstrateConnection substrateConn in connectionSequence)
            {
                ...
                if (weightAbs > _weightThreshold)
                {
                    ...
                    networkConnList.Add(new NetworkConnection(substrateConn._srcNode._id, substrateConn._tgtNode._id, weight));
                }
            }

            #endregion
            #region bias connections
            ...
            NetworkDefinition networkDef = new NetworkDefinition(_inputNodeCount, _outputNodeCount, _activationFnLibrary, _netNodeList, networkConnList);
